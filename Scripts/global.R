...
trade_weights <- read.xlsx("./Data/extra_export_trade_weights.xlsx") 
...
trade_weights_non_eu <- read.xlsx("./Data/extra_export_trade_weights_non_eu.xlsx")
...
model_info_tramo <- read.table("./Data/extra_export_models_tramo.csv", sep = ";", header = TRUE)